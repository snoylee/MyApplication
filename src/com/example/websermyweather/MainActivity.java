...
public class MainActivity extends Activity {
	...
	private TextView weatherTodayT;
	private ImageView tomorrowWhIcon1;
	private ImageView tomorrowWhIcon2;
	private TextView weatherTomorrowT;
	private ImageView afterWhIcon1;
	private ImageView afterWhIcon2;
	private TextView weatherAfterT;
	private TextView weatherCurrentT;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		weatherTodayT = (TextView)findViewById(R.id.weatherToday);
		
		tomorrowWhIcon1 =(ImageView)findViewById(R.id.tomorrowWhIcon1);
		tomorrowWhIcon2 =(ImageView)findViewById(R.id.tomorrowWhIcon2);
		weatherTomorrowT =(TextView)findViewById(R.id.weatherTomorrow);
		
		afterWhIcon1 = (ImageView)findViewById(R.id.afterdayWhIcon1);
		afterWhIcon2 = (ImageView)findViewById(R.id.afterdayWhIcon2);
		weatherAfterT = (TextView)findViewById(R.id.weatherAfterday);
		
		weatherCurrentT =(TextView)findViewById(R.id.weatherCurrent);
	...
	private void showWeather(String city)
	{
		...
		// 更新当天的天气实况
		weatherCurrentT.setText(weatherCurrent);
		// 更新显示今天天气的图标和文本框
		weatherTodayT.setText(weatherToday);
		todayWhIcon1.setImageResource(iconToday[0]);
		todayWhIcon2.setImageResource(iconToday[1]);
		// 更新显示明天天气的图标和文本框
		weatherTomorrowT.setText(weatherTomorrow);
		tomorrowWhIcon1.setImageResource(iconTomorrow[0]);
		tomorrowWhIcon2.setImageResource(iconTomorrow[1]);
		// 更新显示后天天气的图标和文本框
		weatherAfterT.setText(weatherAfterday);
		afterWhIcon1.setImageResource(iconAfterday[0]);
		afterWhIcon2.setImageResource(iconAfterday[1]);
	}
